        ...
        <Grid textAlign='center'>
          <Grid.Row>
            <Grid.Column centered>
              <Button.Group>
                <Button labelPosition="left" icon="left chevron" content="Previous" onClick={this.props.previous}
                  disabled={!this.props.isPreviousActivated} />
                <Button.Or />
                <Button positive labelPosition="right" icon="right arrow" content="Go to Knowledge Package!" href={knowledgePackageLandingPage}
                  disabled={!this.props.isPreviousActivated} />
              </Button.Group>
            </Grid.Column>
          </Grid.Row>
    ...
    return (
      <Button.Group>
        <Button labelPosition="left" icon="left chevron" content="Previous" onClick={this.props.previous}
          disabled={!this.props.isPreviousActivated} />
        <Button.Or />
        <Button labelPosition="right" icon="right chevron" content="Next" onClick={this.props.next}
...
export const DepositFormStepButton = connect(
