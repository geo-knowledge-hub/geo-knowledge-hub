...
import { Card, Container, Divider, Grid, Ref, Sticky, Step, Icon, Image, Segment} from "semantic-ui-react";
import { i18next } from "@translations/invenio_app_rdm/i18next";


export class RDMDepositForm extends Component {

  // Methods to manipulate the form steps
  saveAndContinue = (e) => {
    e.preventDefault();
    this.props.nextStep();
  }
          ...
          <Step.Group vertical>
            <Step active>
              ...
              <Step.Content>
                ...
                <Step.Description>Knowledge Package metadata</Step.Description>
              </Step.Content>
            </Step>
            <Step>
              <Icon name="file" />
              <Step.Content>
                ...
                <Step.Description>Knowledge Package files</Step.Description>
              </Step.Content>
            </Step>
          </Step.Group>
            ...
            <Grid.Row>
              <Grid.Column width={11}>
                ...
                <AccordionField
                  fieldPath=""
                  active={true}
                  label={i18next.t("Basic information 22")}
                  ui={this.accordionStyle}
                >
