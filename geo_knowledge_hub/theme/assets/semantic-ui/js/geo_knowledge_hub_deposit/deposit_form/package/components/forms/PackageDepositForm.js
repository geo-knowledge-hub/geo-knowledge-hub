...
const PackageRefresherComponent = ({ deposit, onRecordChange }) => {
  if (deposit.record.id && onRecordChange) {
    onRecordChange(deposit.record);
  }
  return <></>;
};

const PackageRefresher = connect(PackageRefresherComponent);

export class PackageDepositForm extends Component {
  constructor(props) {
    super(props);
    ...
    // Side effects
    this.onRecordChange = this.props?.onRecordChange;
  }
    ...
    return (
      <Container id="rdm-deposit-form">
        ...
        >
          <Grid stackable>
            <Grid.Row>
              <Grid.Column width={4}>{this.props.headerSelector}</Grid.Column>
              <Grid.Column width={12}>
                {/* ToDo: Review the radius of this component! */}
          ...
          <Grid className="mt-10">
            <Grid.Column mobile={16} tablet={16} computer={11}>
              ...
              <AccordionField
                ...
                active
                label={i18next.t("Initiatives and audiences")}
              >
                <WorkProgrammeActivityField
                  required
                  initialSuggestions={
              ...
              <AccordionField
                ...
                active
                label={i18next.t("Publisher, Funding and licenses")}
              >
                <PublisherField />
              ...
              <AccordionField
                ...
                active
                label={i18next.t("Related and alternate identifiers")}
              >
                <IdentifiersField
          ...
          <PackageRefresher onRecordChange={this.onRecordChange} />
        </DepositFormApp>
      </Container>
    );
  }
